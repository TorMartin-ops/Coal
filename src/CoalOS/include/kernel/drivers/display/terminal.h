...
#include <kernel/drivers/input/keyboard.h> // For KeyEvent

/* --- Configuration --- */
// VGA_ADDRESS is defined in vga_hardware.h
#define VGA_COLS    80
#define VGA_ROWS    25
...
// VGA colors are defined in vga_hardware.h as macros
...
/**
 * @brief Formatted printing to the terminal using va_list (thread-safe).
 * @param format The format string.
 * @param args Variable argument list.
 */
void terminal_vprintf(const char* format, va_list args);
